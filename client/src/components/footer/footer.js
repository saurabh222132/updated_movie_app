          ...
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 my-4 w-full xl:w-1/5">
              ...
              <p class="text-justify">
                CineMate is your ultimate movie companion, offering
                comprehensive information on thousands of films, from
                blockbusters to classics. Enjoy personalized recommendations,
                read and share reviews, and manage your watchlist with ease.
                Watch trailers, find local showtimes, and book tickets directly
                through the app.
              </p>
            </div>
            ...
            <div class="px-4 my-4 w-full sm:w-auto">
              ...
              <ul class="leading-8">
                ...
                <li>
                  <a href="#" class="hover:text-blue-400">
                    Bollywood 90's movies
                  </a>
                </li>
                <li>
                  <a href="#" class="hover:text-blue-400">
                    Top 50 movies in hindi dubbed
                  </a>
                </li>
                <li>
                  <a href="#" class="hover:text-blue-400">
        ...
        <div class="container mx-auto px-4">
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 w-full text-center sm:w-auto sm:text-left">
              Copyright © {new Date().getFullYear()} - Cinemate. All Rights
              Reserved.
            </div>
            <div class="px-4 w-full text-center sm:w-auto sm:text-left">
              This site is maintained by CinaMate Pvt Ltd.
            </div>
          </div>
        </div>
      </div>
